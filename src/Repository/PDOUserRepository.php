...
final class PDOUserRepository implements UserRepository
{
    ...
    {
        $sql = [];
        $insertSQL = 'INSERT INTO users (id, username, passwordHash, email, createdAt) VALUES';
        $insertData = [];
        /**
         * @var UserEntity $user
         */
    ...
    {
        $sql = 'SELECT id,username,passwordHash,email FROM users WHERE username = :username';
